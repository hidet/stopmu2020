...
fnames = ["mu-_mom%d_gaus10_Ne%satm_gausbeam30_132air_075kapton"%(int(mom),p1) for mom in Mom]
Mom=Mom/10.
...
legend.Draw("same")
c1.SaveAs("mu-_stoppos_momdep_Ne%satm_gausbeam30_air132_kapron075_momgaus10.pdf"%(p1))
...
legend.Draw("same")
c2.SaveAs("mu-_target_stoppos_momdep_Ne%satm_gausbeam30_air132_kapton075_momgaus10.pdf"%(p1))
...
plt.tight_layout()
plt.savefig("Ne%satm_tesaccept_stopmu_per_sec_air132_kapton075_momgaus10_gausbeam30.pdf"%(p1))
...
plt.tight_layout()
plt.savefig("Ne%satm_stopmu_per_sec_air132_kapton075_momgaus10.pdf"%(p1))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_150kW_air132_kapton075_momgaus10_gausbeam30.pdf"%(p1))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_550kW_air132_kapton075_momgaus10_gausbeam30.pdf"%(p1))

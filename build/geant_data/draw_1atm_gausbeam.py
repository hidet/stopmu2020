...
#fnames_air = ["mu-_mom%d_bite5_Ne1atm_gausbeam_120air"%(int(mom)) for mom in Mom]
...
plt.legend()
plt.tight_layout()
plt.savefig("Ne1atm_tesaccept_stopmu_per_sec.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne1atm_stopmu_Bq_150kW.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne1atm_stopmu_Bq_550kW.pdf")

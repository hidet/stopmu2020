...
fnames = ["mu-20MeV_Mylar75um_Ne1atm",
          "mu-17MeV_Mylar75um_Ne01atm",
          "mu-16MeV_Mylar75um_Ne01atm",
          "mu-15MeV_Mylar75um_Ne01atm",
          "mu-14MeV_Mylar75um_Ne01atm"]
...
for i in xrange(len(fnames)):
    ...
    hs[i].Scale(bscale[i])
    if i==0:
        hs[i].SetTitle("mu- stopped position momentum dependence")
        ...
        hs[i].Draw("histsame")
legend.Draw("same")
c1.SaveAs("mu-stoppos_momdep_Ne01atm.pdf")

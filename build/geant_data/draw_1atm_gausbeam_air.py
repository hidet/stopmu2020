...
#fnames = ["mu-_mom%d_bite5_Ne1atm_gausbeam_120air"%(int(mom)) for mom in Mom]
fnames = ["mu-_mom%d_gaus3_Ne1atm_gausbeam_120air"%(int(mom)) for mom in Mom]
...
legend.Draw("same")
c1.SaveAs("mu-_stoppos_momdep_Ne1atm_gausbeam_air_gausmom.pdf")
...
legend.Draw("same")
c2.SaveAs("mu-_target_stoppos_momdep_Ne1atm_gausbeam_air_gausmom.pdf")
...
plt.ylabel("# of stopped $\mu^-$ on Ne 1atm target with the TES acceptance [/sec]")
plt.title("stopped $\mu^-$ within TES position +- 5 cm")
plt.ylim(-1000.,1e5)
plt.legend()
plt.tight_layout()
plt.savefig("Ne1atm_tesaccept_stopmu_per_sec_air_gausmom.pdf")
...
plt.title("stopped $\mu^-$ on Ne 1 atm target")
plt.legend()
plt.tight_layout()
plt.savefig("Ne1atm_stopmu_per_sec_air_gausmom.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne1atm_stopmu_Bq_150kW_air_gausmom.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne1atm_stopmu_Bq_550kW_air_gausmom.pdf")

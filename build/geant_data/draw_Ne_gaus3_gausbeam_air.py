...
legend.Draw("same")
c1.SaveAs("mu-_stoppos_momdep_Ne%satm_gausbeam_air_momgaus.pdf"%(p1))
...
legend.Draw("same")
c2.SaveAs("mu-_target_stoppos_momdep_Ne%satm_gausbeam_air_momgaus.pdf"%(p1))
...
plt.tight_layout()
plt.savefig("Ne%satm_tesaccept_stopmu_per_sec_air_momgaus.pdf"%(p1))
...
plt.tight_layout()
plt.savefig("Ne%satm_stopmu_per_sec_air_momgaus.pdf"%(p1))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_150kW_air_momgaus.pdf"%(p1))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_550kW_air_momgaus.pdf"%(p1))

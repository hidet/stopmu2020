...
fnames = ["mu-_mom%d_gaus3_Ne%satm_gausbeam_120air"%(int(mom),patm) for mom in Mom]
Mom=Mom/10.
...
legend.Draw("same")
c1.SaveAs("mu-_stoppos_momdep_Ne%satm_gausbeam_air_momgaus.pdf"%(patm))
...
legend.Draw("same")
c2.SaveAs("mu-_target_stoppos_momdep_Ne%satm_gausbeam_air_momgaus.pdf"%(patm))
...
plt.ylabel("# of stopped $\mu^-$ on Ne %s atm target [/sec]"%(patm2))
plt.title("stopped $\mu^-$ within TES position +- 5 cm")
plt.ylim(-1000.,1e4)
plt.legend()
plt.tight_layout()
plt.savefig("Ne%satm_tesaccept_stopmu_per_sec_air_momgaus.pdf"%(patm))
...
plt.xlabel("Momentum [MeV/c]")
plt.ylabel("# of stopped $\mu^-$ on Ne %s atm target [/sec]"%(patm2))
plt.title("stopped $\mu^-$ on Ne %s atm target"%(patm2))
plt.legend()
plt.tight_layout()
plt.savefig("Ne%satm_stopmu_per_sec_air_momgaus.pdf"%(patm))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_150kW_air_momgaus.pdf"%(patm))
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne%satm_stopmu_Bq_550kW_air_momgaus.pdf"%(patm))

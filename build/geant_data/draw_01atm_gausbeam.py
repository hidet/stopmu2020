...
#fnames_air = ["mu-_mom%d_bite5_Ne01atm_gausbeam_120air"%(int(mom)) for mom in Mom]
...
plt.ylabel("# of stopped $\mu^-$ on Ne 0.1 atm target with the TES acceptance [/sec]")
plt.title("stopped $\mu^-$ within TES position +- 5 cm")
plt.ylim(-1000.,1e4)
plt.legend()
plt.tight_layout()
plt.savefig("Ne01atm_tesaccept_stopmu_per_sec.pdf")

plt.figure()
plt.plot(Mom,stop_rate*i_150kw,"o-",label='150kW')# stop/sec
plt.plot(Mom,stop_rate*i_550kw,"o-",label='550kW')# stop/sec
plt.xlabel("Momentum [MeV/c]")
plt.ylabel("# of stopped $\mu^-$ on Ne 0.1 atm target [/sec]")
plt.title("stopped $\mu^-$ on Ne 1 atm target")
plt.legend()
plt.tight_layout()
plt.savefig("Ne01atm_stopmu_per_sec.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne01atm_stopmu_Bq_150kW.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne01atm_stopmu_Bq_550kW.pdf")

...
#fnames_air = ["mu-_mom%d_bite5_Ne05atm_gausbeam_120air"%(int(mom)) for mom in Mom]
...
plt.ylabel("# of stopped $\mu^-$ on Ne 0.5 atm target with the TES acceptance [/sec]")
plt.title("stopped $\mu^-$ within TES position +- 5 cm")
plt.ylim(-1000.,5e4)
plt.legend()
plt.tight_layout()
plt.savefig("Ne05atm_tesaccept_stopmu_per_sec.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Ne05atm_stopmu_per_sec.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne05atm_stopmu_Bq_150kW.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("Activity_Ne05atm_stopmu_Bq_550kW.pdf")
